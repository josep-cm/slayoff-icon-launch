  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h1 className="text-8xl lg:text-9xl font-black leading-none mb-8">
              <span className="text-jet-black block mb-4">SlayOff</span>
            </h1>
            <Badge className="bg-white/90 backdrop-blur-sm text-jet-black border-2 border-jet-black/20 px-8 py-4 text-xl font-bold mb-8 shadow-lg">
            ...
            <div className="space-y-10">
              <div className="space-y-8">
                <h2 className="text-6xl lg:text-7xl font-black leading-tight">
                  <span className="text-jet-black">From Outfit</span>
                  <br />
                  <span className="text-gradient">to Icon</span>
                </h2>
                <p className="text-3xl font-bold text-jet-black leading-relaxed">
                  Let the World See You
                </p>
                <p className="text-xl text-jet-black/70 max-w-lg leading-relaxed font-medium">
              ...
              <div className="pt-8">
                <p className="text-3xl font-black text-jet-black mb-3">Slay the Day, Every Day!</p>
                <p className="text-xl text-jet-black/70 font-semibold">Your style journey starts here</p>
              </div>
            </div>
            
            <div className="relative">
              <div className="bg-gradient-to-br from-white/90 to-fashion-blush-pink/60 backdrop-blur-sm rounded-3xl p-10 h-[600px] flex items-center justify-center relative overflow-hidden shadow-2xl border border-white/50">
                <div className="absolute inset-6 bg-gradient-to-b from-jet-black/5 to-jet-black/15 rounded-2xl flex flex-col items-center justify-center">
                  <div className="text-9xl mb-6">📱</div>
                  <div className="space-y-4 text-center w-full max-w-sm">
                    <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 mx-4 shadow-xl border border-jet-black/10">
                      <div className="flex items-center gap-3 mb-4">
                        <div className="w-10 h-10 bg-jet-black/20 rounded-full"></div>
                        <div className="text-left">
                          <div className="text-lg font-bold text-jet-black">@fashionista</div>
                          <div className="text-sm text-jet-black/70 font-medium">Slaying today's look</div>
                        </div>
                      </div>
                      <div className="w-full h-40 bg-gradient-to-br from-fashion-blush-pink to-fashion-electric-lavender/30 rounded-xl mb-4 flex items-center justify-center shadow-inner">
                        <span className="text-4xl">👗</span>
                      </div>
                      <div className="flex justify-between text-sm font-semibold text-jet-black/70">
                        <span>❤️ 2.3k</span>
                        <span>💬 156</span>
                        <span>🔥 Trending</span>
                      </div>
      ...
      <section className="py-24 px-4 gradient-lavender">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-5xl lg:text-6xl font-black text-jet-black mb-6">
              Your Fashion Journey
            </h2>
            <p className="text-2xl text-jet-black/70 max-w-3xl mx-auto font-medium">
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            {/* Phase 1 */}
            <Card className="border-4 border-jet-black/30 shadow-2xl bg-white/95 backdrop-blur-sm hover:shadow-3xl transition-all duration-300 transform hover:scale-105">
              <CardContent className="p-12">
                <div className="flex items-center gap-4 mb-8">
                  <Badge className="bg-jet-black text-white px-6 py-3 text-xl font-bold">Phase 1</Badge>
                  <Sparkles className="h-8 w-8 text-electric-lavender" />
                </div>
                <h3 className="text-4xl font-black text-jet-black mb-6">
                  Build Your Fashion Identity
                </h3>
                <p className="text-jet-black/70 mb-8 text-xl font-medium">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-jet-black text-lg">Share Your Outfits</h4>
                      <p className="text-jet-black/70 font-medium">Upload daily looks and style inspirations</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-jet-black text-lg">Discover Community</h4>
                      <p className="text-jet-black/70 font-medium">Connect with like-minded fashion enthusiasts</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-jet-black text-lg">Get Ranked</h4>
                      <p className="text-jet-black/70 font-medium">Climb the style leaderboards and gain recognition</p>
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            {/* Phase 2 */}
            <Card className="border-4 border-jet-black shadow-2xl bg-gradient-to-br from-jet-black/5 to-jet-black/15 hover:shadow-3xl transition-all duration-300 transform hover:scale-105">
              <CardContent className="p-12">
                <div className="flex items-center gap-4 mb-8">
                  <Badge className="bg-gradient-to-r from-jet-black to-electric-lavender text-white px-6 py-3 text-xl font-bold">Phase 2</Badge>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-jet-black text-lg">Brand Discovery</h4>
                      <p className="text-jet-black/70 font-medium">Get discovered by fashion brands seeking influencers</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-jet-black text-lg">Product Tagging</h4>
                      <p className="text-jet-black/70 font-medium">Tag products in your posts and earn commissions</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-jet-black text-lg">Influence & Earn</h4>
                      <p className="text-jet-black/70 font-medium">Turn your fashion expertise into a revenue stream</p>
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="border-4 border-white/30 shadow-2xl bg-white/10 backdrop-blur-sm hover:bg-white/15 transition-all duration-300 transform hover:scale-105">
              <CardContent className="p-12 text-center">
                <div className="bg-white p-8 rounded-3xl shadow-inner mb-6 mx-auto w-fit">
                  <QrCode className="h-32 w-32 text-jet-black mx-auto" />
                </div>
      ...
      {/* Footer Section */}
      <footer className="bg-jet-black text-white py-20 px-4">
        <div className="max-w-7xl mx-auto">
